...
for n_neighbors = 10
    for M = 30
        ...
        %eig_filename = ['C:\Users\DELL\Desktop\threemoons\comparision\simple10-30\n_',num2str(n_neighbors),'_M_',num2str(M),'.mat'];
...
%                             end
                        ...
                        disp(['--averagetime:' num2str(totaltime/10)]);
                        %%
                        if flag == 0
                            break;
                        end
